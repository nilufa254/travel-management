                    ...
                    <div class="card card-info">
                        ...
                        <form action="<?php echo SITE_URL . 'inc/settingsController.php'; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="about_heading" class="col-sm-2 col-form-label">About Heading</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="about_heading" class="form-control" id="about_heading" value="<?php echo !empty($settings['about_heading']) ? $settings['about_heading'] : ''; ?>" placeholder="Enter About Us Text">
                                    </div>
                                </div>
