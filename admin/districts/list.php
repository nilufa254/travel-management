        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <a href="<?php echo SITE_URL; ?>admin/districts/add.php" class="btn btn-success">Add District  <i class="fas fa-plus" style="font-size: 10px;"></i></a>
                </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        // MySQL connection
                        if ($conn = dbConnect()) {
                            $query = "SELECT `districts`.*, `division`.`name` AS `division_name` FROM `districts` JOIN `division` ON `division`.`ID`= `districts`.`division_id` WHERE 1;";
                        ...
                        ?>
                                    <tr>
                                        ...
                                        <td><?php echo $district['short']; ?></td>
                                        <td><?php echo $district['division_name']; ?></td>
                                        <td>
                                            <a href="<?php echo SITE_URL . 'admin/districts/edit.php?districtID=' . $district['ID']; ?>" class="btn btn-info">Edit</a>
                                            <form class="d-inline" action="<?php echo SITE_URL . 'inc/districtController.php'; ?>" method="post">
